...
<div class="container">
  <h2 align="center">Tambah Data Kematian</h2>
  <form id="formID" action= "proses_tambah_datakematian.php" method= "POST" >
                                    ...
                                    <?php
                                      ...
                                      ?>
                                        ...
                                        <tr>
                                          ...
                                          <td><a href="admin.php?container=tambah_datakematian&&tdnik=<?php echo $data['nik']; ?>&&td_id=<?php echo $data['no_id']; ?>&&td_namalgkp=<?php echo $data['nama_lgkp'];?>&&td_tgllhr=<?php echo $data['tgl_lhr'];?>&&td_jk=<?php echo $data['jk'];?>&&td_alamat=<?php echo $data['alamat'];?>&&td_rt=<?php echo $data['rt']?>&&td_rw=<?php echo $data['rw']; ?>">PILIH</td>
                                        </tr>
