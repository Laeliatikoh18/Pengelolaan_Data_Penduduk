...
if($count<1){
  ...
  while($datapen=mysql_fetch_array($tampil)){
   ...
   <tr>
    ...
    <td><a href='delete_pendudukkeluar.php?nik=".$datapen['nik']."' <span class='glyphicon glyphicon-trash'></span> Hapus</a>
    <a href='admin.php?container=lihat_datapenduduk_keluar&nik=".$datapen['nik']."' <span class='glyphicon glyphicon-open-file'></span> Lihat</a>
    <a href='admin.php?container=update_pindahkeluar&nik=".$datapen['nik']."' <span class='glyphicon glyphicon-edit'</span>Edit</a></td>  
   </tr>
   ";
   }}
  ?>
  ...
  <strong> <td><a href="admin.php?container=tambah_datapendudukkeluar" align="right"
