...
if($count<1){
  ...
  while($datapen=mysql_fetch_array($tampil)){
   ...
   <tr>
    ...
    <td>".$datapen['rt']."</td>
    <td>".$datapen['rw']."</td>
    <td><a href='delete_penduduk.php?no_id=".$datapen['no_id']."' <span class='glyphicon glyphicon-trash'></span> Hapus</a>
    <a href='admin.php?container=lihat_datapenduduk&no_id=".$datapen['no_id']."' <span class='glyphicon glyphicon-open-file'></span>Lihat</a>
    <a href='admin.php?container=update_penduduk&no_id=".$datapen['no_id']."' <span class='glyphicon glyphicon-edit'</span>Edit</a></td>  
   </tr>
   ";
   }}
  ?>
  ...
  <strong> <td><a href="admin.php?container=tambah_datapenduduk" align="right"
  class="btn btn-info" role="button">Tambah Data</a></td></strong>
  <strong> <td><a href="laporan_datapendudukall.php" align="right"
  class="btn btn-info" role="button" target="_blank">Cetak</a></td></strong>
