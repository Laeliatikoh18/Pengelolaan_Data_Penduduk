...
<div class="container">
<h2 align="center">Keterangan Data Penduduk Masuk</h2>
<br><br>
  <form id="formID" action= "proses_sk_datapendudukmasuk.php" enctype="multipart/form-data" method= "POST" >
  <style>
    th, td {
    padding: 5px;
    }</style>
  ...
  <tr><td style="width:350px;">
       <input type="text" class="form-control"  name="no_kk" placeholder="NO KK" ></td>
       <td style="width:350px;"><input type="text" class="form-control"  name="tmpt_lhr" placeholder="TEMPAT LAHIR" >
        </td>
  ...
  <tr><td style="width:350px;">
      <input type="text" class="form-control"  name="nik" placeholder="NIK" ></td>
      <td style="width:350px;">
  ...
  <tr><td style="width:350px;">
      ...
      <td style="width:350px;">
        <input type="text" class="form-control"  name="no_akta_lhr" placeholder="NO AKTA LAHIR" >
      </td>
      <td style="width:350px;">
  ...
  <tr><td style="width:350px;">
      ...
      <td style="width:350px;">
        <input type="text" class="form-control"  name="no_akta_kwn" placeholder="NO AKTA KAWIN" >
      </td>
      <td style="width:350px;">
        <select name="pekerjaan" class="form-control">
              ...
              <option value="PNS">Perangkat Desa</option>
              <option value="Pelajar/ Mahasiswa">Pelajar/ Mahasiswa</option>
              <option value="Pelajar/ Mahasiswa">Mengurus Rumah Tangga</option>
            </select>
      </td></tr>
  <tr><td>Alamat Asal</td><td>Alasan Pindah</td></tr>
  <tr><td style="width:350px;">
      <textarea type="text" class="form-control"  name="alamat_asal" placeholder="ALAMAT ASAL" ></textarea> 
      </td>
      <td style="width:350px;">
  ...
  <tr><td style="width:350px;">
      <input type="text" class="form-control"  name="no_id" placeholder="NO ID" >
      <td style="width:350px;">
