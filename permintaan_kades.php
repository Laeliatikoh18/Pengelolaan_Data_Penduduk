...
<div class="container">
  ...
  <table class="table table-striped" id="data">
    ...
    <tbody>
<?php
  $query = "SELECT * FROM kematian WHERE konfirm='1' ORDER BY nik ASC";
...
<?php
$nik = $datapen['nik'];
       ?><form method='POST'><td><a href="proses_konfirm_kades.php?nik=<?php echo $nik;?>" class="btn btn-info">konfirm</a></form></td>
