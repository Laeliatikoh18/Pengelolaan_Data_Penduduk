...
$hasil=mysql_query($sql);
  while($datapen=mysql_fetch_array($tampil)){
   ...
   <tr>
    ...
    <td><a href='delete_kelahiran.php?id_kelahiran=".$datapen['id_kelahiran']."' <span class='glyphicon glyphicon-trash'></span> Hapus</a>
    <a href='admin.php?container=lihat_datapenduduk_kelahiran&id_kelahiran=".$datapen['id_kelahiran']."' <span class='glyphicon glyphicon-open-file'></span> Lihat</a>
    <a href='admin.php?container=update_datakelahiran&id_kelahiran=".$datapen['id_kelahiran']."' <span class='glyphicon glyphicon-edit'</span>Edit</a></td>  
   </tr>
   ";
   }}
  ?>
  ...
  <strong> <td><a href="admin.php?container=tambah_datakelahiran" align="right"
